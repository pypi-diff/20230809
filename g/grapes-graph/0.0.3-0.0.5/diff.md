# Comparing `tmp/grapes-graph-0.0.3.tar.gz` & `tmp/grapes-graph-0.0.5.tar.gz`
...
+gzip compressed data, was "grapes-graph-0.0.5.tar", last modified: Wed Aug  9 04:20:09 2023, max compression
```

## Comparing `grapes-graph-0.0.3.tar` & `grapes-graph-0.0.5.tar`
...
+drwxr-xr-x   0 ericwang   (501) staff       (20)        0 2023-08-09 04:20:09.259367 grapes-graph-0.0.5/
+-rw-r--r--   0 ericwang   (501) staff       (20)     1069 2023-07-23 02:02:04.000000 grapes-graph-0.0.5/LICENSE.txt
+-rw-r--r--   0 ericwang   (501) staff       (20)       27 2023-08-02 01:47:05.000000 grapes-graph-0.0.5/MANIFEST.in
+-rw-r--r--   0 ericwang   (501) staff       (20)      865 2023-08-09 04:20:09.259191 grapes-graph-0.0.5/PKG-INFO
+-rw-r--r--   0 ericwang   (501) staff       (20)      235 2023-08-02 23:43:26.000000 grapes-graph-0.0.5/README.md
+-rw-r--r--   0 ericwang   (501) staff       (20)      851 2023-08-09 04:19:47.000000 grapes-graph-0.0.5/pyproject.toml
+-rw-r--r--   0 ericwang   (501) staff       (20)       24 2023-07-24 23:55:23.000000 grapes-graph-0.0.5/requirements.txt
+-rw-r--r--   0 ericwang   (501) staff       (20)       38 2023-08-09 04:20:09.259409 grapes-graph-0.0.5/setup.cfg
+-rw-r--r--   0 ericwang   (501) staff       (20)      344 2023-08-08 23:43:01.000000 grapes-graph-0.0.5/setup.py
+drwxr-xr-x   0 ericwang   (501) staff       (20)        0 2023-08-09 04:20:09.254373 grapes-graph-0.0.5/src/
+drwxr-xr-x   0 ericwang   (501) staff       (20)        0 2023-08-09 04:20:09.255410 grapes-graph-0.0.5/src/grapes/
+-rw-r--r--   0 ericwang   (501) staff       (20)       48 2023-08-09 04:15:01.000000 grapes-graph-0.0.5/src/grapes/__init__.py
+drwxr-xr-x   0 ericwang   (501) staff       (20)        0 2023-08-09 04:20:09.258065 grapes-graph-0.0.5/src/grapes/cgraph/
+-rw-r--r--   0 ericwang   (501) staff       (20)     2814 2023-08-09 03:53:54.000000 grapes-graph-0.0.5/src/grapes/cgraph/__init__.pyi
+-rw-r--r--   0 ericwang   (501) staff       (20)    16889 2023-08-09 04:04:57.000000 grapes-graph-0.0.5/src/grapes/cgraph/cgraph.c
+-rw-r--r--   0 ericwang   (501) staff       (20)     2167 2023-08-09 00:40:48.000000 grapes-graph-0.0.5/src/grapes/cgraph/cgraph.h
+-rw-r--r--   0 ericwang   (501) staff       (20)     2373 2023-08-02 18:58:53.000000 grapes-graph-0.0.5/src/grapes/cgraph/deque.c
+-rw-r--r--   0 ericwang   (501) staff       (20)      579 2023-07-31 01:23:47.000000 grapes-graph-0.0.5/src/grapes/cgraph/deque.h
+-rw-r--r--   0 ericwang   (501) staff       (20)     3077 2023-08-04 02:12:26.000000 grapes-graph-0.0.5/src/grapes/cgraph/heap.c
+-rw-r--r--   0 ericwang   (501) staff       (20)      657 2023-07-31 01:23:52.000000 grapes-graph-0.0.5/src/grapes/cgraph/heap.h
+-rw-r--r--   0 ericwang   (501) staff       (20)      236 2023-08-02 17:53:27.000000 grapes-graph-0.0.5/src/grapes/cgraph/macros.h
+-rw-r--r--   0 ericwang   (501) staff       (20)     3838 2023-08-09 04:00:34.000000 grapes-graph-0.0.5/src/grapes/cgraph/trav.c
+-rw-r--r--   0 ericwang   (501) staff       (20)      626 2023-08-09 04:05:04.000000 grapes-graph-0.0.5/src/grapes/cgraph/trav.h
+drwxr-xr-x   0 ericwang   (501) staff       (20)        0 2023-08-09 04:20:09.258783 grapes-graph-0.0.5/src/grapes_graph.egg-info/
+-rw-r--r--   0 ericwang   (501) staff       (20)      865 2023-08-09 04:20:09.000000 grapes-graph-0.0.5/src/grapes_graph.egg-info/PKG-INFO
+-rw-r--r--   0 ericwang   (501) staff       (20)      583 2023-08-09 04:20:09.000000 grapes-graph-0.0.5/src/grapes_graph.egg-info/SOURCES.txt
+-rw-r--r--   0 ericwang   (501) staff       (20)        1 2023-08-09 04:20:09.000000 grapes-graph-0.0.5/src/grapes_graph.egg-info/dependency_links.txt
+-rw-r--r--   0 ericwang   (501) staff       (20)       25 2023-08-09 04:20:09.000000 grapes-graph-0.0.5/src/grapes_graph.egg-info/requires.txt
+-rw-r--r--   0 ericwang   (501) staff       (20)       14 2023-08-09 04:20:09.000000 grapes-graph-0.0.5/src/grapes_graph.egg-info/top_level.txt
+drwxr-xr-x   0 ericwang   (501) staff       (20)        0 2023-08-09 04:20:09.258893 grapes-graph-0.0.5/tests/
+-rw-r--r--   0 ericwang   (501) staff       (20)      712 2023-08-09 01:15:47.000000 grapes-graph-0.0.5/tests/test_dijkstra.py
```

### Comparing `grapes-graph-0.0.3/LICENSE.txt` & `grapes-graph-0.0.5/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `grapes-graph-0.0.3/PKG-INFO` & `grapes-graph-0.0.5/PKG-INFO`
...
### Comparing `grapes-graph-0.0.3/pyproject.toml` & `grapes-graph-0.0.5/pyproject.toml`
...
### Comparing `grapes-graph-0.0.3/src/grapes/cgraph/__init__.pyi` & `grapes-graph-0.0.5/src/grapes/cgraph/__init__.pyi`
...
### Comparing `grapes-graph-0.0.3/src/grapes/cgraph/cgraph.c` & `grapes-graph-0.0.5/src/grapes/cgraph/cgraph.c`
...
### Comparing `grapes-graph-0.0.3/src/grapes/cgraph/deque.c` & `grapes-graph-0.0.5/src/grapes/cgraph/deque.c`
...
### Comparing `grapes-graph-0.0.3/src/grapes/cgraph/deque.h` & `grapes-graph-0.0.5/src/grapes/cgraph/deque.h`

 * *Files identical despite different names*

### Comparing `grapes-graph-0.0.3/src/grapes/cgraph/heap.c` & `grapes-graph-0.0.5/src/grapes/cgraph/heap.c`
...
### Comparing `grapes-graph-0.0.3/src/grapes/cgraph/heap.h` & `grapes-graph-0.0.5/src/grapes/cgraph/heap.h`

 * *Files identical despite different names*

### Comparing `grapes-graph-0.0.3/src/grapes_graph.egg-info/PKG-INFO` & `grapes-graph-0.0.5/src/grapes_graph.egg-info/PKG-INFO`
