# Comparing `tmp/pyimporters-skos-0.4.95.tar.gz` & `tmp/pyimporters_skos-0.4.99.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyimporters-skos-0.4.95.tar", last modified: Thu Dec 15 17:29:40 2022, max compression
+gzip compressed data, was "pyimporters_skos-0.4.99.tar", last modified: Fri Jan  1 00:00:00 2016, max compression
```

## Comparing `pyimporters-skos-0.4.95.tar` & `pyimporters_skos-0.4.99.tar`

### file list

```diff
@@ -1,19 +1,19 @@
--rw-r--r--   0        0        0       97 2022-12-15 17:28:06.436549 pyimporters-skos-0.4.95/.dockerignore
--rw-r--r--   0        0        0      147 2022-12-15 17:28:06.437548 pyimporters-skos-0.4.95/.gitignore
--rw-r--r--   0        0        0      448 2022-12-15 17:28:06.437548 pyimporters-skos-0.4.95/Dockerfile
--rw-r--r--   0        0        0    10584 2022-12-15 17:28:06.437548 pyimporters-skos-0.4.95/Jenkinsfile
--rw-r--r--   0        0        0      148 2022-12-15 17:28:06.437548 pyimporters-skos-0.4.95/README.md
--rw-r--r--   0        0        0       61 2022-12-15 17:29:39.280970 pyimporters-skos-0.4.95/pyimporters_skos/__init__.py
--rw-r--r--   0        0        0     2751 2022-12-15 17:28:06.438548 pyimporters-skos-0.4.95/pyimporters_skos/skos.py
--rw-r--r--   0        0        0     1977 2022-12-15 17:28:06.439549 pyimporters-skos-0.4.95/pyproject.toml
--rw-r--r--   0        0        0        0 2022-12-15 17:28:06.439549 pyimporters-skos-0.4.95/tests/__init__.py
--rw-r--r--   0        0        0    58318 2022-12-15 17:28:06.440549 pyimporters-skos-0.4.95/tests/data/categories.skos
--rwxr-xr-x   0        0        0     5725 2022-12-15 17:28:06.440549 pyimporters-skos-0.4.95/tests/data/test.jsonld
--rwxr-xr-x   0        0        0     6431 2022-12-15 17:28:06.440549 pyimporters-skos-0.4.95/tests/data/test.n3
--rwxr-xr-x   0        0        0     9064 2022-12-15 17:28:06.440549 pyimporters-skos-0.4.95/tests/data/test.nt
--rw-r--r--   0        0        0      908 2022-12-15 17:28:06.441549 pyimporters-skos-0.4.95/tests/data/test.nt.zip
--rwxr-xr-x   0        0        0     5306 2022-12-15 17:28:06.441549 pyimporters-skos-0.4.95/tests/data/test.rdf
--rw-r--r--   0        0        0      994 2022-12-15 17:28:06.442549 pyimporters-skos-0.4.95/tests/data/test.rdf.zip
--rw-r--r--   0        0        0     2929 2022-12-15 17:28:06.443549 pyimporters-skos-0.4.95/tests/test_skos.py
--rw-r--r--   0        0        0      769 1970-01-01 00:00:00.000000 pyimporters-skos-0.4.95/setup.py
--rw-r--r--   0        0        0     1444 1970-01-01 00:00:00.000000 pyimporters-skos-0.4.95/PKG-INFO
+-rw-r--r--   0        0        0       97 2023-08-09 05:44:54.947651 pyimporters_skos-0.4.99/.dockerignore
+-rw-r--r--   0        0        0      178 2023-08-09 05:44:54.948650 pyimporters_skos-0.4.99/.gitignore
+-rw-r--r--   0        0        0      448 2023-08-09 05:44:54.949651 pyimporters_skos-0.4.99/Dockerfile
+-rw-r--r--   0        0        0    12849 2023-08-09 05:44:54.949651 pyimporters_skos-0.4.99/Jenkinsfile
+-rw-r--r--   0        0        0      148 2023-08-09 05:44:54.950651 pyimporters_skos-0.4.99/README.md
+-rw-r--r--   0        0        0       61 2023-08-09 05:45:32.052649 pyimporters_skos-0.4.99/pyimporters_skos/__init__.py
+-rw-r--r--   0        0        0     2751 2023-08-09 05:44:54.952651 pyimporters_skos-0.4.99/pyimporters_skos/skos.py
+-rw-r--r--   0        0        0     1977 2023-08-09 05:44:54.953651 pyimporters_skos-0.4.99/pyproject.toml
+-rw-r--r--   0        0        0        0 2023-08-09 05:44:54.953651 pyimporters_skos-0.4.99/tests/__init__.py
+-rw-r--r--   0        0        0    58318 2023-08-09 05:44:54.954651 pyimporters_skos-0.4.99/tests/data/categories.skos
+-rwxr-xr-x   0        0        0     5725 2023-08-09 05:44:54.954651 pyimporters_skos-0.4.99/tests/data/test.jsonld
+-rwxr-xr-x   0        0        0     6431 2023-08-09 05:44:54.954651 pyimporters_skos-0.4.99/tests/data/test.n3
+-rwxr-xr-x   0        0        0     9064 2023-08-09 05:44:54.955651 pyimporters_skos-0.4.99/tests/data/test.nt
+-rw-r--r--   0        0        0      908 2023-08-09 05:44:54.956651 pyimporters_skos-0.4.99/tests/data/test.nt.zip
+-rwxr-xr-x   0        0        0     5306 2023-08-09 05:44:54.957651 pyimporters_skos-0.4.99/tests/data/test.rdf
+-rw-r--r--   0        0        0      994 2023-08-09 05:44:54.958651 pyimporters_skos-0.4.99/tests/data/test.rdf.zip
+-rw-r--r--   0        0        0     2929 2023-08-09 05:44:54.960651 pyimporters_skos-0.4.99/tests/test_skos.py
+-rw-r--r--   0        0        0      769 1970-01-01 00:00:00.000000 pyimporters_skos-0.4.99/setup.py
+-rw-r--r--   0        0        0     1444 1970-01-01 00:00:00.000000 pyimporters_skos-0.4.99/PKG-INFO
```

### Comparing `pyimporters-skos-0.4.95/Jenkinsfile` & `pyimporters_skos-0.4.99/Jenkinsfile`
           ...
           steps {
             script {
               ...
               withCredentials([gitUsernamePassword(credentialsId: 'bitbucket-user', gitToolName: 'git-tool')]) {
                 sh "echo '\"\"\"Sherpa knowledge import plugins\"\"\"' > pyimporters_skos/__init__.py"
                 sh "echo '__version__ = \"${MAJOR_VERSION}.${MINOR_VERSION}.${env.BUILD_ID}\"' >> pyimporters_skos/__init__.py"
                 sh 'git commit pyimporters_skos/__init__.py -m "[Jenkins CI] Commit on version files" || echo "No changes to commit"'
                 sh 'git push'
               }
             }
           }
...
### Comparing `pyimporters-skos-0.4.95/pyimporters_skos/skos.py` & `pyimporters_skos-0.4.99/pyimporters_skos/skos.py`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/pyproject.toml` & `pyimporters_skos-0.4.99/pyproject.toml`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/data/categories.skos` & `pyimporters_skos-0.4.99/tests/data/categories.skos`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/data/test.jsonld` & `pyimporters_skos-0.4.99/tests/data/test.jsonld`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/data/test.n3` & `pyimporters_skos-0.4.99/tests/data/test.n3`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/data/test.nt` & `pyimporters_skos-0.4.99/tests/data/test.nt`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/data/test.nt.zip` & `pyimporters_skos-0.4.99/tests/data/test.nt.zip`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/data/test.rdf` & `pyimporters_skos-0.4.99/tests/data/test.rdf`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/data/test.rdf.zip` & `pyimporters_skos-0.4.99/tests/data/test.rdf.zip`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/tests/test_skos.py` & `pyimporters_skos-0.4.99/tests/test_skos.py`

 * *Files identical despite different names*

### Comparing `pyimporters-skos-0.4.95/setup.py` & `pyimporters_skos-0.4.99/setup.py`
...
### Comparing `pyimporters-skos-0.4.95/PKG-INFO` & `pyimporters_skos-0.4.99/PKG-INFO`
